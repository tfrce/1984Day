...
var social = {
    initialize: function () {
        $.getJSON('http://sharing.taskforce.is/?type=facebook&url='+window.location.href, function(data) {
        ...
        $.getJSON('http://sharing.taskforce.is/?type=twitter&url='+window.location.href, function(data) {
            var count = data.count;
            $('.twitter-button').attr('count', count);
        })
        $.getJSON('http://sharing.taskforce.is/?type=googleplus&url='+window.location.href, function(data) {
            var count = data.count;
